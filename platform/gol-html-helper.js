function GolHtmlHelper() {
	...
	that.addCssRules = function addCssRules() {
		...
		that.addCssRule('#gol-army-final-0 {height: 20px; width: 50%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #' + colorsHex[0] + '; position: absolute; left:50%; opacity: 0; transition: 1s opacity ease;}');
		that.addCssRule('#gol-army-final-1 {height: 20px; width: 50%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #' + colorsHex[1] + '; position: absolute; left:50%; opacity: 0; transition: 1s opacity ease;}');
